async function getNeko() {
    ...
    const response = await fetch('https://nekos.best/api/v2/neko'/* + categories[getRandomInt(0, categories.length - 1)]*/);
    ...
    document.getElementById("artist_link").innerHTML = json.results[0].artist_name;
