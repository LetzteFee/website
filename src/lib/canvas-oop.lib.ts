...
class Canvas {
  ...
  public getWidth(): number {
    if (typeof this.width != "number") {
      doLog(
        "canvas class getWidth()",
        "Width is not defined yet. You have to run createCanvas first",
        true
      );
    }
    return this.width;
  ...
  public getHeight(): number {
    if (typeof this.height != "number") {
      doLog(
        "canvas class getHeight()",
        "Height is not defined yet. You have to run createCanvas first",
        true
      );
    }
    return this.height;
  ...
  public getFrameCount(): number {
    if (typeof Canvas.frameCount != "number") {
      throw "Error: framecount not defined yet";
    }
    return Canvas.frameCount;
  }
  public getAnimator(
    max: number = 1,
    perioden_laenge_frames: number = 240
  ): number {
    return Math.round(
      (Math.sin(
